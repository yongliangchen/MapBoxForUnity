...
namespace Mx.Config
{
	...
	public class SoundConfigDatabase:IDatabase
	{
		...
		public const string DATA_PATH = "SoundConfig";
       
		private string[][] m_datas;
        private Dictionary<string, SoundConfigData> dicData = new Dictionary<string, SoundConfigData>();
        private List<SoundConfigData> listData = new List<SoundConfigData>();
        ...
        public List <SoundConfigData> GetAllData()
        {
            return listData;
        }
