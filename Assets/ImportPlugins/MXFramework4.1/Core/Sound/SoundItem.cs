...
namespace Mx.Sound
{
    public sealed class SoundItem : MonoBehaviour
    {
        #region 数据申明
        ...
        public DelSoundCallback OnSoundCallback { get; set; }
        ...
        {
            if (isPlay) FurtherSoundPlayback();
        }

        private void Awake()
        {
            if (audioRoot == null) audioRoot = new GameObject("SoundRoot").transform;
        }
        ...
        private void Update()
        {
            if (isPlay)
            {
                ...
                if (Time <= PlayTime)
                {
                    ...
                    if (OnSoundCallback != null) OnSoundCallback(SoundName, State, Time, PlayTime);
                }
        ...
        public void FurtherSoundPlayback()
        {
            isPlay = true;
            Audio.Play();
            State = SoundState.Play;
